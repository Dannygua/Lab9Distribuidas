...
public interface ServicioOperaciones {
    ...
    @RequestWrapper(localName = "resta", targetNamespace = "http://UDDI/", className = "uddi.Resta")
    @ResponseWrapper(localName = "restaResponse", targetNamespace = "http://UDDI/", className = "uddi.RestaResponse")
    @Action(input = "http://UDDI/ServicioOperaciones/restaRequest", output = "http://UDDI/ServicioOperaciones/restaResponse")
    public double resta(
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "multiplicacion", targetNamespace = "http://UDDI/", className = "uddi.Multiplicacion")
    @ResponseWrapper(localName = "multiplicacionResponse", targetNamespace = "http://UDDI/", className = "uddi.MultiplicacionResponse")
    @Action(input = "http://UDDI/ServicioOperaciones/multiplicacionRequest", output = "http://UDDI/ServicioOperaciones/multiplicacionResponse")
